...
<html lang="en">
<head>
    <title>GrantedBy.Me - JSP Demo - Register</title>
    <meta charset="utf-8">
    ...
    <script>
        grantedByMeConfig = {
            ...
            postToken: '',
            initCall: 'getRegisterToken',
            pollCall: 'getRegisterState'
        };
    </script>
    ...
    <link rel="stylesheet" href="https://cdn-dev.grantedby.me/components/modal/css/grantedbyme.min.css">gbm-ruby-sdk
